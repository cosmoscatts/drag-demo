...
import gaoyagangImage from '~/images/drag/gaoyagang.svg'
import momeijiImage from '~/images/drag/momeiji.svg'
import reguoluImage from '~/images/drag/reguolu.svg'

const defaultEquipImages = [
  gaoyagangImage,
  momeijiImage,
  reguoluImage,
] as string[]
...
const graphicGroups = computed<any[]>(() => {
  const images = [
    ...defaultEquipImages,
...
<template>
  <div h-full w-full>
    <a-collapse :bordered="false">
      <a-collapse-item v-for="item in graphicGroups" :key="item.name" :header="`${item.name}(${item.list.length})`">

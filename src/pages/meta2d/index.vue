...
<template>
  <div>
    ...
    <div grid="~ cols-6" border="1 base" :style="{ height: contentHeight }">
      <div col-span-1 border="r-1 base" :style="{ height: contentHeight }" of-y-auto>
        <Meta2dGraphics />
      </div>
      <Meta2dContextMenu>
        <Meta2dView v-if="!previewVisible" :style="{ height: contentHeight, width: '100%' }" :class="showProps ? 'col-span-4' : 'col-span-5'" />
      </Meta2dContextMenu>
